 ...
 */
const ShuttlesIndicator = ({ value = '0/0' }) => (
  <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border transition-all duration-200 bg-slate-100 dark:bg-slate-800 border-slate-300 dark:border-slate-700">
    <Truck size={16} className="text-slate-600 dark:text-slate-300" />
